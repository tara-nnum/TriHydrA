"""Summarise local and analogue evidence without mixing their purposes."""
...
@dataclass(frozen=True)
class Layer3Summary:
    """Separate local and analogue summaries for one target station."""
...
def summarise_layer3(
    ...
    *,
    ...
    """Create two scores; deliberately do not produce one combined verdict."""
