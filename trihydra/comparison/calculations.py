...
def run_generic_comparison(
    ...
    *,
    ...
    Layer 2 uses one common start-to-end window while retaining each series'
    own internal gaps. Only optional daily metrics use pairwise-valid dates.
    """
    ...
    reference_l2_input = prepared.reference_selected
    candidate_l2_input = prepared.candidate_selected
    ...
    summary_metrics = {
        ...
        "layer2_comparison_score_percent": composite_summary.get(
            "layer2_score_percent"
        ),
        "layer2_comparison_maximum_assessable_score": composite_summary.get(
