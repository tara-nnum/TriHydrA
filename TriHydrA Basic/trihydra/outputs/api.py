    ...
    *,
    ...
    if isinstance(result, TriHydrANetworkResult):
        ...
        network_summary.write_text(
            render_network_summary(result.summary), encoding="utf-8"
        )
