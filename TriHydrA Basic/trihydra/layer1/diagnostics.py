...
from trihydra.layer1.basic_checks import run_basic_checks
from trihydra.layer1.behaviour_checks import run_behavioural_checks
...
def _run_layer1_checks(
    ...
    """Run structural and behavioural checks once on one native series."""
...
def run_layer1_diagnostics(
    ...
    """Run Layer 1 independently on observation and optional model series."""
...
def finalise_layer1_contract(
    ...
    result["thresholds_used"] = {
        ...
        "layer1_minor_concerns_score": comp["classification"]["minor_concerns_minimum_score"],
        "layer1_needs_review_score": comp["classification"]["needs_review_minimum_score"],
    }
    frames = []
